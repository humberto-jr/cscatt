...
# compiler (ex.: CC=mpicc), the internal variable USE_MPI is used to trigger
# all MPI-related configuration.
#
...
#
# IBM xlc and mpixlc compilers: both thread-safe versions (_r-suffixed) are also
# considered while the use of OpenMP is implied in all cases anyhow.
#
...
#
# Fortran compilers: if linkage of object files generated by Fortran compilers
# is intended, the variable FC is used to setup the compiler identifier such
# that its core libraries are automatically included during the link step.
# GNU gfortran is taken as default option. Example: make CC=icc FC=ifort.
#
...
matrix: $(MODULES_DIR)/matrix.c $(MODULES_DIR)/matrix.h $(MODULES_DIR)/gsl_lib.h $(MODULES_DIR)/globals.h
	@echo "$<:"
...
a+d_multipole: a+d_multipole.c $(MODULES_DIR)/globals.h $(MODULES_DIR)/mpi_lib.h $(MODULES_DIR)/file.h $(MODULES_DIR)/pes.h $(PES_OBJECT) matrix.o
	@echo "$<:"
	$(CC) $(CFLAGS) $< -o $@.out file.o pes.o nist.o math.o mpi_lib.o matrix.o $(PES_OBJECT) $(LDFLAGS) $(LINEAR_ALGEBRA_LIB) $(FORT_LIB)
	@echo

multipole_print: multipole_print.c $(MODULES_DIR)/globals.h $(MODULES_DIR)/file.h $(MODULES_DIR)/pes.h nist.o math.o
	@echo "$<:"
...
basis_resize: basis_resize.c $(MODULES_DIR)/globals.h $(MODULES_DIR)/matrix.h $(MODULES_DIR)/file.h $(MODULES_DIR)/fgh.h matrix.o file.o fgh.o mpi_lib.o math.o
	@echo "$<:"
	$(CC) $(CFLAGS) -D$(USE_MACRO) $< -o $@.out matrix.o file.o fgh.o mpi_lib.o math.o $(LDFLAGS) $(LINEAR_ALGEBRA_LIB) $(FORT_LIB)
	@echo
